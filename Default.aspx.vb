...
Partial Class Figs_Default
    ...
    Protected Sub on_addNew_click(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Protected Sub on_login_click(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Protected Sub on_others_click(ByVal sender As Object, ByVal e As System.EventArgs)
        Response.Redirect("EditOthers.aspx")
    End Sub

    Protected Sub methodology_lBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles methodology_lBtn.Click
